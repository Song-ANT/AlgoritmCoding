...
namespace AlgorithmCoding
{
    ...
    0.1 초	1024 MB	2846	1749	1646	62.777%
    문제
    ...
    public class Q_30802 : KataBase
    {
        ...
        public override void Example()
        {
            ...
            (t, p) = Array.ConvertAll(Console.ReadLine().Split(), int.Parse) switch {var arr => (arr[0], arr[1]) };
        ...
        private void Solution()
        {
            ...
            {
                if (item == 0) continue;
                else T += item % t == 0 ? item /t : item / t + 1;
            }
    ...
    #region ShortCoding
    public class Q_30802_ShortCoding
    {
        public void ShortCoding()
        {
            ...
            var set = Array.ConvertAll(Console.ReadLine().Split(), int.Parse);
            ...
            Console.Write("{0}\n{1} {2}", ts, count / set[1], count % set[1]);
        }
    }
    #endregion

    #region CPP
    public class Q_30802_CPP
    {
        /*
         #include<iostream>
        using namespace std;
        int main(){
        int r,t,p,i=0,a[6],sum=0;cin>>r;
        while(i<6)cin>>a[i++];
        cin>>t>>p;
        i=0;while(i<6)sum+=a[i]%t==0?a[i++]/t:(a[i++]/t)+1;
        cout<<sum<<"\n"<<(r/p)<<" "<<(r%p)<<"\n";}
         */
    }
